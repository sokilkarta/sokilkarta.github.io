...
function buildUI(){
  ...
  panel.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;padding-bottom:8px;border-bottom:1px solid rgba(74,222,128,0.18);">
      <span style="color:rgba(74,222,128,0.85);font-size:9px;letter-spacing:2px;text-transform:uppercase;">SHARED MAP</span>
      <div style="display:flex;gap:5px;align-items:center;">
        <span id="syncAdminBadge" style="display:none;background:rgba(251,191,36,0.2);color:#fbbf24;border:1px solid rgba(251,191,36,0.5);border-radius:4px;padding:1px 6px;font-size:9px;">ADMIN</span>
        <span id="syncConnStatus" style="color:#f87171;font-size:9px;">OFFLINE</span>
      </div>
    </div>
    <div style="display:flex;gap:5px;align-items:center;margin-bottom:8px;">
      <span style="color:rgba(255,255,255,0.45);font-size:9px;min-width:54px;">ROOM:</span>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:8px;">
      <button id="syncShareBtn"
        ...
        MY<br>STATE<br><span style="font-size:9px;color:rgba(255,255,255,0.35);">OFF</span>
      </button>
      <button id="syncWatchBtn"
        style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.18);color:#94a3b8;border-radius:8px;padding:8px 4px;cursor:pointer;font-family:monospace;font-size:10px;text-align:center;line-height:1.4;transition:all .2s;">
        OTHERS<br>STATE<br><span style="font-size:9px;color:rgba(255,255,255,0.35);">OFF</span>
      </button>
    </div>
...
function updateAdminBadge(){
  ...
  btn.textContent       = isAdmin?'ADMIN ON (TURN OFF)':'ADMIN MODE';
}
...
function updateUI(){
  ...
  if(sBtn){
    ...
    sBtn.innerHTML=`MY<br>STATE<br><span style="font-size:9px;color:${isSharing?'#4ade80':'rgba(255,255,255,0.35);'};">${isSharing?'ON':'OFF'}</span>`;
  }
  if(wBtn){
    ...
    wBtn.innerHTML=`OTHERS<br>STATE<br><span style="font-size:9px;color:${isWatching?'#93c5fd':'rgba(255,255,255,0.35);'};">${isWatching?'ON':'OFF'}</span>`;
  }
}
